...
jQuery.fn.jparallax.settings = {
  ...
  triggerExposesEdges:  true,          // Sets whether the trigger pulls layer edges into view in trying to centre layer content.
	xparallax:				    true,						// Sets directions to move in
	yparallax:				    true,						//
	xorigin:					    2.1,				    // Sets default alignment - only comes into play when travel is not 1
	yorigin:					    2.1,				    //
	xtravel:              1,              // Factor by which travel is amplified
	ytravel:              1,              //
	takeoverFactor:		    0.77,						// Sets rate of decay curve for catching up with target mouse position
	...
	frameDuration:        2							// In milliseconds
};
